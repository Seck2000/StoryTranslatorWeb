...
avec un mode oral fond\'e sur Whisper \cite{whisper2022}.
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Whisper} (OpenAI) transcrit la voix mot pour mot \cite{whisper2022} ;
...
\begin{itemize}[leftmargin=*]
  \item \textbf{Node.js} et \textbf{Express} : API REST \cite{express}.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Whisper (OpenAI)} : transcription orale litt\'erale \cite{whisper2022}.
\end{itemize}
