...
\newcommand{\reporttitle}{{\huge \textsc{Rapport} \\ \vspace{0.5cm} {\Large Projet de fin d'\'etudes}}}
...
\begin{titlepage}
\begin{center}
{\Large UNIVERSIT\'E DU QU\'EBEC \`A RIMOUSKI}\\[0.4cm]
\textsc{\large D\'epartement de math\'ematiques, d'informatique et de g\'enie}\\[0.8cm]

\textbf{\textsc{\Large PROJET DE FIN D'ETUDES EN INFORMATIQUE\\ \vspace{0.3cm} INF39615-7T}}\\[1.0cm]

\HRule \\[0.4cm]
{ \huge \bfseries \reporttitle}\\[0.2cm]
{\Large StoryTranslator}\\[0.2cm]
\HRule \\[1.5cm]
\end{center}

\begin{flushleft} \large
\textit{\textsc{\textbf{\'Equipe :}}}\\
\reportauthorOne \\[0.5cm]
